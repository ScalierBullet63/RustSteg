...
impl fmt::Display for StegError {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            StegError::UnsupportedCarrierFormat => write!(f, "Unsupported carrier format"),
            StegError::InvalidPath => write!(f, "Invalid path"),
            StegError::PathNotFound => write!(f, "Path not found"),
